            ...
            <div class="col-lg-6">
                <div class="d-flex gap-3">
                    ...
                    <div class="flex-fill position-relative" >
                        <img src="<?php echo e(asset('home/image.png')); ?>" alt="Ambulance" class="img-fluid rounded shadow-sm" style="object-fit: cover; height: 300px; width: 100%;">
                    ...
                    <!-- Second Image -->
                    <div class="flex-fill position-relative">
                        <img src="<?php echo e(asset('home/john.jpeg')); ?>" alt="CEO" class="img-fluid rounded shadow-sm" style="object-fit: cover; height: 300px; width: 100%;">
                        <div class="position-absolute bottom-0 start-0 bg-primary text-white p-2 m-2 rounded">
                            CEO Mr. John
                        </div>
                    </div>
...
<div class="modal fade" id="signupModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4">
                <form id="signupForm" action="<?php echo e(route('patientssubmit')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
</html><?php /**PATH C:\xampp\htdocs\RapidRescue\resources\views/index.blade.php ENDPATH**/ ?>