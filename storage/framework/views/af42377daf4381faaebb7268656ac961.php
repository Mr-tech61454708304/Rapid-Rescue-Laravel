...
<div class="wrapper">
  ...
  <img class="animation__shake"
     src="<?php echo e(asset('admin/dist/img/shayannew.png')); ?>"
     alt="AdminLTELogo"
     height="60"
     width="60"
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo e(asset('/admin/dist/img/shayannew.png')); ?>" class="square shadow" alt="User Image" width="200" height="200" style="border-radius: 22px;">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('adminsignup')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>signup page<p>
                </a>
              </li>
        ...
        <div class="col-12">
            <div class="table-responsive">
                <table class="table table-dark table-hover table-striped align-middle text-center">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($movie->id); ?></td>
                                <td><?php echo e($movie->full_name); ?></td>
                                <td><?php echo e($movie->email); ?></td>
                                <td><?php echo e($movie->phone_number); ?></td>
                                <td><?php echo e($movie->date_of_birth); ?></td>
                                <td><?php echo e(ucfirst($movie->account_type)); ?></td>
                                <td><?php echo e($movie->blood_type); ?></td>
                                <td><?php echo e($movie->primary_physician ?? 'N/A'); ?></td>
                                <td><?php echo e($movie->known_allergies ?? 'N/A'); ?></td>
                                <td><?php echo e($movie->current_medications ?? 'N/A'); ?></td>
                                <td><?php echo e($movie->medical_consent ? 'Yes' : 'No'); ?></td>
                                <td><?php echo e($movie->terms_accepted ? 'Yes' : 'No'); ?></td>
                                <td><?php echo e($movie->communications_accepted ? 'Yes' : 'No'); ?></td>
                                <td>
                                    <a href="#" 
...
<?php /**PATH C:\xampp\htdocs\RapidRescue\resources\views/adminlayout/index.blade.php ENDPATH**/ ?>